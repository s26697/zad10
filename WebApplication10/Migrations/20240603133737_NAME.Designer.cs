...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication10.Models.Prescription", b =>
                {
                    b.HasOne("WebApplication10.Models.Doctor", "Doctors")
                        .WithMany("Prescriptions")
                        .HasForeignKey("IdDoctor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication10.Models.Patient", "Patients")
                        .WithMany("Prescriptions")
            ...
            modelBuilder.Entity("WebApplication10.Models.Prescription_Medicament", b =>
                {
                    b.HasOne("WebApplication10.Models.Medicament", "Medicaments")
                        .WithMany("PrescriptionMedicaments")
                        .HasForeignKey("IdMedicament")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication10.Models.Prescription", "Prescriptions")
                        .WithMany("PrescriptionMedicaments")
